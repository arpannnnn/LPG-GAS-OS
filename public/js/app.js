    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          generateProductHTML = function _generateProductHTML() {
            return products.map(function (product) {
              return "\n                    <tr>\n                        <td class=\"border px-4 py-2 text-green-900\">".concat(product.name, "</td>\n                        <td class=\"border px-4 py-2\"><img style=\"width: auto;height: 100px;\" class=\"h-40 mb-4 mx-auto\" src=\"/public/img/").concat(product.image, "\" alt=\"").concat(product.name, "\"></td> \n                        <td class=\"border px-4 py-2\">").concat(product.price, "</td>\n                        <td class=\"border px-4 py-2\">").concat(product.size, "</td>\n                        <td class=\"border px-4 py-2\">\n                        <div class=\"inline-block relative w-64\">\n                            <form action=\"/admin/product/delete\" method=\"POST\">\n                                <input type=\"hidden\" name=\"productID\" value=\"").concat(product._id, "\">\n                                <button type=\"submit\" class=\"bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded\">Delete</button>\n                            </form>\n                        </td>\n                    </tr>\n                ");
            }).join("");
          };
          generateUsersHTML = function _generateUsersHTML(users) {
            return users.map(function (user) {
              return "\n                    <tr>\n                        <td class=\"border px-4 py-2 text-green-900\">".concat(user.name, "</td>\n                        <td class=\"border px-4 py-2\">").concat(user.email, "</td>\n                        <td class=\"border px-4 py-2\">").concat(user.role, "</td>\n                    </tr>\n                ");
            }).join("");
          };
          ...
          _context.next = 12;
          return axios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/admin/users", {
            headers: {
        ...
        case 12:
          ...
          _context.next = 15;
          return axios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/admin/products", {
            headers: {
              "X-Requested-With": "XMLHttpRequest"
            }
          }).then(function (res) {
...
addToCart.forEach(function (btn) {
  btn.addEventListener("click", function (e) {
    var gas = JSON.parse(btn.dataset.gas);
    updateCart(gas);
  });
});
...
function updateStatus(order) {
  ...
  statuses.forEach(function (status) {
    ...
    if (dataProp === order.status) {
      stepCompleted = false;
      time.innerText = moment_moment__WEBPACK_IMPORTED_MODULE_2___default()(order.updatedAt).format("hh:mm A");
...
socket.on("orderUpdated", function (data) {
  ...
  updatedOrder.updatedAt = moment_moment__WEBPACK_IMPORTED_MODULE_2___default()().format();
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_0__.loadStripe)("pk_test_51NTJ95BeehU2T2NQ6DHkPuu16SdHsqp4D2SktDBPxZzntArTf5olQfkPIIa5knfwZ3tWIlTTpLJsOVlxBUy65gaQ00p6Qd99nE");
        case 3:
